    ...
    if script_tag:
        try:
            ...
            return {
                ...
                "name": product_info.get('name', 'No Name Found'),
                "sku": product_info.get('sku', 'No SKU Found'),
                "price": product_info.get('price', 'Nan'),
                "min_price": product_info.get('min_price', 'Nan'),
                "max_price": product_info.get('max_price', 'Nan'),
                "min_price_format": product_info.get('min_price_format', 'No Min Price Format Found'),
                "max_price_format": product_info.get('max_price_format', 'No Max Price Format Found'),
                "gold_weight": product_info.get('gold_weight', 'No Gold Weight Found'),
                "none_metal_weight": product_info.get('none_metal_weight', 'No None Metal Weight Found'),
                "fixed_silver_weight": product_info.get('fixed_silver_weight', 'No Fixed Silver Weight Found'),
                "material_design": product_info.get('material_design', 'No Material Design Found'),
                "qty": product_info.get('qty', 'No Quantity Found'),
                "collection": product_info.get('collection', 'No Collection Found'),
                "collection_id": product_info.get('collection_id', 'No Collection ID Found'),
                "product_type": product_info.get('product_type', 'No Product Type Found'),
                "product_type_value": product_info.get('product_type_value', 'No Product Type Value Found'),
                "category": product_info.get('category', 'No Category Found'),
                "category_name": product_info.get('category_name', 'No Category Name Found'),
                "store_code": product_info.get('store_code', 'No Store Code Found'),
                "platinum_palladium_info_in_alloy": product_info.get('platinum_palladium_info_in_alloy', 'No Platinum Palladium Info Found'),
                "bracelet_without_chain": product_info.get('bracelet_without_chain', 'No Bracelet Without Chain Info Found'),
                "show_popup_quantity_eternity": product_info.get('show_popup_quantity_eternity', 'No Show Popup Quantity Eternity Info Found'),
                "visible_contents": product_info.get('visible_contents', 'No Visible Contents Found'),
                "gender": product_info.get('gender', 'No Gender Found')
            }
